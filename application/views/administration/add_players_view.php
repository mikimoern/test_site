	...
	<div id="wrapper">
		...
		<div id="content">
			...
			<div id="center">
				...
				<div class="add">
					<form name="add_players" action="<?= base_url().'players/add';?>" method="post">
						<div>
							...
							<p>Номер гравця<br />
								<input type="text" name="number" value="<?= set_value('number'); ?>" /><br />
							...
							<p>
								<label>Виберіть позицію<br />
									<select name="position" >
										<option value="Воротар"<?=set_value('position','Воротар', TRUE);?>>Воротар</option>
										<option value="Захисник"<?=set_value('position','Захисник');?>>Захисник</option>
										<option value="Півзахисник"<?=set_value('position','Півзахисник');?>>Півзахисник</option>
										<option value="Нападник"<?=set_value('position','Нападник');?>>Нападник</option>
									</select>
								</label>
